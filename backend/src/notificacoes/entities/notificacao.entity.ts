...
export enum TipoNotificacao {
  ...
  MEDICAO_NAO_LIQUIDADA = 'MEDICAO_NAO_LIQUIDADA',
  PAGAMENTO_SEM_MEDICAO = 'PAGAMENTO_SEM_MEDICAO',

  // Pré-OS de publicidade (Lei 12.232)
  PRE_OS_ENVIADA = 'PRE_OS_ENVIADA',
  PRE_OS_DEVOLVIDA = 'PRE_OS_DEVOLVIDA',
  PRE_OS_ACEITA = 'PRE_OS_ACEITA',

  // Nota Fiscal Fornecedor
  NF_DISPONIVEL = 'NF_DISPONIVEL',
  NF_RECUSADA = 'NF_RECUSADA',

  // Demandas (ciclo de vida — transparência p/ o setor requisitante)
  DEMANDA_APROVADA = 'DEMANDA_APROVADA',
  DEMANDA_REJEITADA = 'DEMANDA_REJEITADA',
  DEMANDA_EM_CONTRATACAO = 'DEMANDA_EM_CONTRATACAO',
