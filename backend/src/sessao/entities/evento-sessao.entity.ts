...
export enum TipoEvento {
  ...
  // Aceitacao da proposta (IN 73/2022 art. 29; plano E3)
  ACEITACAO_CONVOCADA = 'ACEITACAO_CONVOCADA',
  ACEITACAO_PRORROGACAO_SOLICITADA = 'ACEITACAO_PRORROGACAO_SOLICITADA',
  ACEITACAO_PRAZO_PRORROGADO = 'ACEITACAO_PRAZO_PRORROGADO',
  PROPOSTA_ADEQUADA_ENVIADA = 'PROPOSTA_ADEQUADA_ENVIADA',
  PROPOSTA_ACEITA = 'PROPOSTA_ACEITA',
  UNIDADE_FRACASSADA = 'UNIDADE_FRACASSADA',
  ...
  /** Mensagem PRIVADA agente ↔ licitante na negociação (dados_adicionais.visibilidade = 'PRIVADA'). */
  NEGOCIACAO_MENSAGEM = 'NEGOCIACAO_MENSAGEM',
