...
- **Pendências do Degrau 2:** (2.5) aposentar módulo `contratacao-direta` órfão; (opcional) prorrogação automática da janela de lances; teste do fluxo PNCP no treina (exige credenciais PNCP configuradas no ambiente).
