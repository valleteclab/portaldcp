...
- **Falta na E3**: ME/EPP (etapa BENEFICIO_MPE antes da aceitação, usando o gancho), negociação (depois da aceitação; exige nova proposta adequada se o valor mudar), desempate art. 60/sorteio (gancho do ranking), julgamento técnico, critérios técnica e preço/melhor técnica/maior retorno; valores da proposta readequada ainda não alimentam a homologação (E6).
